...
\begin{document}
	...
	\clearpage
		\sectionwithtoc{Suppen und Eintöpfe}
			...
			\input{Hauptgerichte/Suppen_und_Eintoepfe/Kuerbisgulasch/Kuerbisgulasch}
	...
	\clearpage
		\sectionwithtoc{Fingerfood}
			...
			\input{Hauptgerichte/Fingerfood/Herzhafte_Zucchini-Waffelbites/Herzhafte_Zucchini-Waffelbites}
			\input{Hauptgerichte/Fingerfood/Blätterteig-Schnecken_mit_Spinat/Blätterteig-Schnecken_mit_Spinat}
			\input{Hauptgerichte/Fingerfood/Kaesestangen/Kaesestangen}
	...
	\clearpage
		\sectionwithtoc{Snacks}
			...
			\input{Nachspeisen_und_Snacks/Snacks/Energieriegel_mit_Blaubeeren/Energieriegel_mit_Blaubeeren}
			\input{Nachspeisen_und_Snacks/Snacks/Protein_Flapjacks/Protein_Flapjacks}
	...
	\indexprologue{\noindent Insgesamt\:\therecipeCntr\:Rezepte enthalten die folgende Begriffe. Es werden nur markante Zutaten oder Schlagworte referenziert.}
	\printindex
