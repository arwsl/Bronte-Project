\begin{recipe}
    ...
    \ingredients{
        ...
        \SI{4}{\EL} & dunkle Johannisbeermarmelade \\
        \SI{60}{\ml} & Wasser \\
    ...
    \preparation{
        ...
        \step Den Teig kalt stellen, etwa über Nacht im Kühlschrank oder einige Studen im Tiefkühler. Der Teig lässt sich dann einfacher verarbeiten und klebt nicht so sehr.

        \step Für die Zubereitung der Lebkuchen jeweils etwa \SI{1}{\TL} Teig auf eine Backoblate geben und mit den Fingern andrücken und bis an de Rand verteilen. Die Lebkuchen dann etwa \SI{12}{\minute} bis \SI{15}{\minute} backen, bis sie leicht braun werden. Dabei öfter in den Ofen schauen, damit nichts anbrennt.
    ...
    \hint{Für das Original ``Elisenlebkuchen'' die Johannisbeermarmelade durch Aprikosenmarmelade ersetzen, je \SI{1}{\msp} gemahlnenen Zimt und Koriander hinzufügen. Die Lebkuchen mit Kuvertüre und blanchierten Mandelhälften verzieren.}
